...
/** Controller REST para consultar el historial de llamadas */
@Slf4j
@RestController
...
public class CallHistoryController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CallHistoryResponse> findById(
    ...
    @GetMapping("/path")
    public ResponseEntity<List<CallHistoryResponse>> findByPath(
    ...
    @GetMapping("/success")
    public ResponseEntity<List<CallHistoryResponse>> findBySuccess(
            @Parameter(
                            description =
